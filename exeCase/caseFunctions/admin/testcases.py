...
@allure.feature("品类基础功能")
class Test1:

    # @allure.story('')
    @pytest.mark.parametrize('caseInfo', PyConfig.caseInfos["品类基础功能"])
...
@allure.feature("品牌基础功能")
class Test2:

    # @allure.story('')
    @pytest.mark.parametrize('caseInfo', PyConfig.caseInfos["品牌基础功能"])
    def test_run(self, caseInfo):
        header = {'contenType':'application/json',
                  'cookie':'uc_token=e957c609b1554018ae97fe1dc86e9cf1'}
        url = caseInfo['route']
